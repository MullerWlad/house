...
/*function syncHtml(done) {
    ...
    gulp.watch('./src/css/fixed-properties.min.css').on('change', browserSync.reload);
    gulp.watch('./src/css/general-style.min.css').on('change', browserSync.reload);
    done();
};*/
